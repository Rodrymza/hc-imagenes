    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-card rounded-2xl shadow-2xl w-full max-w-md">
              ...
              <div className="flex items-center gap-3">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-input bg-transparent rounded-lg text-sm font-bold text-foreground focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                  />
                </div>
                <span className="text-muted-foreground font-bold mt-5">a</span>
                <div className="flex-1">
                  <label className="block text-xs font-bold text-muted-foreground mb-1">
                    Hasta
                  </label>
        ...
        <div className="px-6 py-4 border-t border-border flex gap-3">
          <button
            onClick={onClose}
            className="flex-1 px-4 py-2.5 text-sm font-bold text-muted-foreground hover:text-foreground hover:bg-accent rounded-lg transition-colors"
          >
            Cancelar
          </button>
          <button
