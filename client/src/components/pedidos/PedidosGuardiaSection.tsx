...
export function PedidosGuardiaSection({
  ...
  return (
    <div className="max-w-7xl mx-auto mt-6 animate-in slide-in-from-bottom-4 duration-500">
      <div className="bg-card rounded-2xl border-2 border-amber-100 dark:border-amber-900 shadow-md overflow-hidden">
        ...
        <div className="p-4 bg-amber-50/30 dark:bg-transparent min-h-[150px] flex flex-col justify-center">
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className="rounded-xl p-4 bg-card border border-border animate-pulse flex items-center gap-4"
                >
            ...
            <div className="py-10 flex flex-col items-center justify-center text-muted-foreground opacity-60">
